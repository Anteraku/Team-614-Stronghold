...
public class DriveThroughLowBarByDistance extends CommandGroup {
    ...
    public  DriveThroughLowBarByDistance(/*double firstTurn, double alignDistance, double secondTurn, double crossDistance, double shootAngle*/) {
...
//    	
//    	//Drive towards the low bar to become aligned with it
//    	addSequential(new DriveStraightForADistance(alignDistance, driveStraightSpeed, true, true)); //Constants.FIELD_WIDTH/2
//    	addSequential(new WaitCommand(1));
//    	
//    	//Turn right to face the low bar
//    	addSequential(new TurnToAngle(90, turnSpeed));
...
//    	
//    	//Drive through the low bar
//    	addSequential(new DriveStraightForADistance(Constants.DISTANCE_TO_SHOOT_ZONE, driveStraightSpeed, true, true));
//    	addSequential(new WaitCommand(1));
//    	
//    	addParallel(new RaiseLift());
//    	
