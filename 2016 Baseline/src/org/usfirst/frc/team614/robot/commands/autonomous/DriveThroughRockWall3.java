 ...
 *
 */
public class DriveThroughRockWall3 extends CommandGroup {
    ...
    public  DriveThroughRockWall3() {
    	...
    	//addSequential(new DriveStraightForATime(2, driveStraightSpeed, true, true));
    	//addSequential(new WaitCommand(1));
    	
    	addSequential(new DriveStraightForATime(.5, .5, true, false));
    	addSequential(new WaitCommand(1));
    	...
    	//Drive through the rockwall
    	addParallel(new DriveStraightForATime(driveStraightTime, driveStraightSpeed, true, true));
