...
public class Drivetrain extends PIDSubsystem {
    ...
    */
    ...
    public double getEncoderTrueDistance(int encoderNum){
    	switch(encoderNum){
    	case LEncoder:
    		return leftGeartrainEncoder.getDistance() * distancePerPulse;
    	case REncoder:
    		return rightGeartrainEncoder.getDistance() * distancePerPulse;
    	default:
    		return 0;
    	}
    }
